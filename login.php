    ...
    <main>
        <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-lg">
                <h1 class="text-center text-2xl font-bold text-indigo-600 sm:text-3xl">Log In</h1>

                <p class="mx-auto mt-4 max-w-md text-center text-gray-500">
                Untuk menikmati seluruh fitur dan fungsionalitas yang kami tawarkan, Nikmati kemudahan dan keuntungan dengan bergabung bersama kami.
                </p>
